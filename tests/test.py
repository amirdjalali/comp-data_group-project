...
from handlers.citation_upload_handler import CitationUploadHandler#, BibliographicEntityUploadHandler
from handlers.citation_query_handler import CitationQueryHandler#, BibliographicEntityQueryHandler
# from engines import FullQueryEngine
# from model import Citation, BibliographicEntity, AuthorSelfCitation, JournalSelfCitation
...
class TestProjectBasic(unittest.TestCase):
    ...
    # don't test this unless you want to push all data to db again
